...
function Slide(_ref) {
  ...
  return /*#__PURE__*/React.createElement(SlideStyles, {
    ref: slideRef,
...
function Slider(_ref) {
  ...
  var prevTranslate = useRef(0);
  var currentIndex = useRef(activeIndex || 0);
  var sliderRef = useRef('slider');
  var animationRef = useRef(null);
  var setPositionByIndex = useCallback(function (w) {
    if (w === void 0) {
      w = dimensions.width;
    }
  ...
  }, /*#__PURE__*/React.createElement(SliderStyles, {
    ref: sliderRef,
