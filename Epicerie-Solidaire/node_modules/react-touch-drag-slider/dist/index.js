...
var _styled = _interopDefault(require('styled-components'));
...
var SlideStyles = _styled.div(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  transition: transform 0.2s ease-out;\n  div {\n    padding: 1rem;\n    height: 100%;\n    width: ", ";\n    height: ", ";\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    user-select: none;\n  }\n  img {\n    max-width: 100%;\n    max-height: 100%;\n  }\n"])), function (props) {
...
function Slide(_ref) {
  var child = _ref.child,
      ...
      _ref$scaleOnDrag = _ref.scaleOnDrag,
      scaleOnDrag = _ref$scaleOnDrag === void 0 ? false : _ref$scaleOnDrag;
  var slideRef = React.useRef('slide');
  ...
  return /*#__PURE__*/React__default.createElement(SlideStyles, {
    ref: slideRef,
...
var SliderStyles = _styled.div(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteralLoose(["\n  all: initial;\n  width: 100%;\n  height: 100%;\n  max-height: 100vh;\n  display: inline-flex;\n  will-change: transform, scale;\n  cursor: grab;\n  .slide-outer {\n    display: flex;\n    align-items: center;\n  }\n"])));

var SliderWrapper = _styled.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteralLoose(["\n  overflow: hidden;\n  width: 100%;\n  height: 100%;\n  max-height: 100vh;\n"])));

function Slider(_ref) {
  var children = _ref.children,
      onSlideComplete = _ref.onSlideComplete,
      onSlideStart = _ref.onSlideStart,
      _ref$activeIndex = _ref.activeIndex,
      activeIndex = _ref$activeIndex === void 0 ? null : _ref$activeIndex,
      _ref$threshHold = _ref.threshHold,
      threshHold = _ref$threshHold === void 0 ? 100 : _ref$threshHold,
  ...
  var startPos = React.useRef(0);
  var currentTranslate = React.useRef(0);
  var prevTranslate = React.useRef(0);
  var currentIndex = React.useRef(activeIndex || 0);
  var sliderRef = React.useRef('slider');
  var animationRef = React.useRef(null);
  var setPositionByIndex = React.useCallback(function (w) {
    if (w === void 0) {
      w = dimensions.width;
    }
  ...
  var transitionOn = function transitionOn() {
    return sliderRef.current.style.transition = "transform " + transition + "s ease-out";
  };

  var transitionOff = function transitionOff() {
    return sliderRef.current.style.transition = 'none';
  };
  ...
  React.useEffect(function () {
    var handleResize = function handleResize() {
      ...
      var _getElementDimensions = getElementDimensions(sliderRef),
    ...
    var handleKeyDown = function handleKeyDown(_ref2) {
      var key = _ref2.key;
      var arrowsPressed = ['ArrowRight', 'ArrowLeft'].includes(key);
  ...
  function touchEnd() {
    ...
    var movedBy = currentTranslate.current - prevTranslate.current;
    if (movedBy < -threshHold && currentIndex.current < children.length - 1) currentIndex.current += 1;
  ...
  return /*#__PURE__*/React__default.createElement(SliderWrapper, {
    className: "SliderWrapper"
  }, /*#__PURE__*/React__default.createElement(SliderStyles, {
    ref: sliderRef,
    ...
    }, /*#__PURE__*/React__default.createElement(Slide, {
      child: child,
